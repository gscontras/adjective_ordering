  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      function plural(word) {
        if (/couch|tomato/.test(word)) {
          return(word + "es");
        } else if (/cheese/.test(word)) {
          return word;
        } else {
          return(word + "s");
        }
      ...
      nouns = plural(stim.Noun)

      $(".adjective").html(stim.Predicate)

      $(".noun").html(nouns)     

      $(".description").html(stim.Predicate + " " + nouns);

      this.sentence_types = _.shuffle(["adjective", "noun"]);
      var sentences = {
        "adjective": "Are those things " + stim.Predicate + "?",
        "noun": "Are those things " + nouns + "?"
      };
    ...
    button : function() {
      if (exp.sliderPost[0] > 0 & exp.sliderPost[1] > 0) {
        this.log_responses();
        _stream.apply(this);
      } else {
        $(".err").show();        
    ...
    log_responses : function() {
      for (var i=0; i<this.sentence_types.length; i++) {
        ...
        exp.data_trials.push({
          ...
          "trial" : exp.phase,
          "predicate" : sentence_type,
          "response" : exp.sliderPost[i],
          "noun" : this.stim.Noun,
          "adjective" : this.stim.Predicate,
