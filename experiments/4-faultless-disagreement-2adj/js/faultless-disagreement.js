  ...
  slides.multi_slider = slide({
    ...
    present_handle : function(stim) {
      ...
      if (stim.number == "1") {
        ...
        $(".utterance1").html("\"That" + this.verbs[0] + " " + det + stim.Predicate1 + " " + stim.Noun + ".\"");

        $(".utterance2").html("\"You're wrong. That" + this.verbs[1] + " " + det + stim.Predicate1 + " " + stim.Noun + ".\"");

      } else {

        $(".utterance1").html("\"That" + this.verbs[0] + " " + det + stim.Predicate1 + " " + stim.Predicate2 + " " + stim.Noun + ".\"");

        $(".utterance2").html("\"You're wrong. That" + this.verbs[1] + " " + det + stim.Predicate1 + " " + stim.Predicate2 + " " + stim.Noun + ".\"");
