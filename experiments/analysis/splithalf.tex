...
\significancetext{From English to Hungarian to Mokilese, speakers exhibit strong ordering preferences in multi-adjective strings (e.g., "the big blue box" vs. "the blue big box"). Rather than a rigid syntax, we show that an adjective's semantics predicts its distance from the modified noun: less subjective adjectives occur linearly closer to nouns they modify.}
...
\begin{figure}[h!]
	\centering
	\fbox{\includegraphics[width=.75\linewidth]{images/order_trial.eps}}
...
\begin{figure}
	\centering\includegraphics[width=2.8in]{plots/naturalness-subjectivity.eps}
