...
Based on the average distance-from-noun scores calculated in Fig.\ \ref{distance-from-noun}, we may infer the ordering preferences in \ref{inferred-order-preferences} via pairwise comparisons between classes.
...
metal	&	material	&	soft	&	texture	\\													
	\end{tabular} \caption{Adjectives and nouns used in experimental stimuli.}\label{stim-table}
\end{table}
...
\begin{table}
	\caption{Pairwise comparisons using t tests with bonferroni correction}
