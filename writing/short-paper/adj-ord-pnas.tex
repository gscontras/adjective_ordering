...
\subsection{Subjectivity} We conducted experiment 1 to evaluate the subjectivity of adjectives and the broader classes to which they belong. Participants either evaluated the potential for faultless disagreement between two differing descriptions of an object (\emph{Experiment 1a: Faultless Disagreement}), or the potential ``subjectivity'' of a single object description (\emph{Experiment 1b: Subjectivity}). The results of these two measures are highly correlated with each other ($r = XXX$; $P < XXX$) (Fig.\ \ref{faultless-subjectivity}).
