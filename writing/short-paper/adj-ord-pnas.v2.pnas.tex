...
\significancetext{``The big blue box'' sounds far more natural than ``the blue big box.'' From English to Hungarian to Mokilese, speakers exhibit strong ordering preferences in multi-adjective strings. Rather than a rigid syntax, we show that an adjective's meaning predicts its distance from the modified noun: less subjective adjectives occur closer to nouns they modify. We therefore find evidence of a broadly applicable linguistic universal, adjective ordering preferences, emerging from general properties of cognition. %This case study of adjective ordering preferences provides evidence for broadly applicable linguistic universals emerging from 
