...
\significancetext{``The big blue box'' is far more natural than ``the blue big box.'' From English to Hungarian to Mokilese, speakers exhibit strong ordering preferences in multi-adjective strings. Rather than a rigid syntax, we show that an adjective's meaning predicts its distance from the modified noun: less subjective adjectives occur closer to nouns they modify. This provides a case study in which universal regularities in language derive from universal psychology of word meaning.\ndg{edit that last sentence.. want a succinct statement of why people should care about adj order.}}
