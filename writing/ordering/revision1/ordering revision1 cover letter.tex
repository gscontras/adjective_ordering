...
\item \emph{p.4: the link between (i) being more inherent to the object and (ii) being a more salient/accessible property was not entirely clear to me.  Can't we
...
\item \emph{p.10: the example about the tacky polyester shirt is very interesting and I think the the question of ``whether speaker goals influence ordering
