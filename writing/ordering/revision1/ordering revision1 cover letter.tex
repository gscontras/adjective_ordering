...
We have been unable to track down the relevant reference mentioned by the reviewer, and so we have refrained from mentioning it in our revision. %\gcs{unless we do track it down and want to mention it} 
Still, if the findings are correctly recalled, they would be very much in line with our proposal: establishing nominal reference seems to be the purview of adjectives that make their semantic contributions early. To the extent that one views Larson's proposal in terms of restrictive vs.~non-restrictive modification, our proposal would be in line with his observations as well. However, it isn't clear to us that the primary distinction to be drawn from Larson's work is one of restrictiveness.
