...
\item \emph{And third, the particular analysis you propose in terms of noise and
	...
	We have provided the requested step-by-step demonstration of how ordering adjectives with respect to subjectivity results in fewer alignment errors, thereby increasing the probability of the listener retrieving the intended referent. 
