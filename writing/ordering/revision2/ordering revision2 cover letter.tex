...
We apologize for making you repeat yourself. Given that our claim about the role of subjectivity in adjective ordering preferences is focused primarily on successful reference resolution, we decided that the discussion of the probability of at least one misclassification was superfluous. We have therefore removed this discussion. However, in addressing your second set of concerns about successful reference resolution (cf.~our response to point 2 below), we have provided a step-by-step demonstration for \emph{small brown box} vs.~\emph{brown small box}. 
We have also moved what was the definition in (3), together with a short explanation, to footnote 1. We chose to keep the definition in a footnote for those readers who are interested in how one could formalize potential for misclassification in a truth-functional semantics.
...
We are particularly grateful to you for raising this concern, as we believe addressing it has substantially clarified our claims and strengthened our argument. Previously, we equivocated on the mechanism whereby modification could break the commutativity of noise. We did this in order to avoid unnecessarily distracting (or contentious) assumptions, but the result, as you rightly point out, was an unnecessarily distracting and contentious lack of clarity. Now, we provide the requested step-by-step demonstration for \emph{small brown box} vs.~\emph{brown small box}, making the minimal assumptions necessary along the way. The chief assumption concerns the relationship between processing resources and the precision of a stochastic classification. 
%
%\bit
%\item[]
...
%\eit
Given that the new demonstration features a good deal of math not common to linguistics articles, we have set this demonstration apart in its own subsection (Section 4.1), advising readers who are already convinced by our argument or wary of math that the demonstration can be skipped.
